...
![Opening前後の二値画像](画像URLをここに貼り付け：binary_before_opening.png と binary_after_opening.png の並べ画像)
...
![外側ROIのイメージ](画像URLをここに貼り付け：result_outer_ok.png と result_outer_ng.png の並べ画像)
...
![内側パターンの判定結果](画像URLをここに貼り付け：result_inner_ok.png と result_inner_ng.png の並べ画像)
...
🔗 [github.com/factory-dx-eng/contour_inspection](https://github.com/factory-dx-eng/contour_inspection)
